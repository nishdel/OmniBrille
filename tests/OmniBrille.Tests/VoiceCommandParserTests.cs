...
public sealed class VoiceCommandParserTests
{
    ...
    [InlineData("go up", VoiceIntentKind.GoUp)]
    [InlineData("parent", VoiceIntentKind.GoUp)]
    [InlineData("root", VoiceIntentKind.GoRoot)]
    [InlineData("home", VoiceIntentKind.GoRoot)]
    [InlineData("open selected", VoiceIntentKind.ActivateSelectedNode)]
    [InlineData("enter selected", VoiceIntentKind.ActivateSelectedNode)]
    ...
    [InlineData("Enter Documents", VoiceIntentKind.OpenVisibleNode, "Documents")]
    [InlineData("go into Project Files", VoiceIntentKind.OpenVisibleNode, "Project Files")]
