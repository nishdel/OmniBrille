...
|---|---|---|---|---|
| 1.1.0 candidate | not installed | n/a | Windows 10 22H2 x64 | Source/headless coverage supports semantic direct-child Structure, Back/Up/Root/Trail, Search, Details, file-open safety, themes, sensory preferences, Voice fallbacks, and synchronized graph/list automation. Exact local fresh install and public-v1.0.0 upgrade lifecycle checks cover package identity, Light/Dark launch, the pinned known-WAV Voice path, registration, cleanup, and preference preservation; interactive visual/chrome, real hardware, and assistive-technology qualification remain release gates |
