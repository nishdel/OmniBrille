...
|---|---|---|---|---|
| 1.1.0 candidate | not installed | n/a | Windows 10 22H2 x64 | Source/headless coverage supports semantic direct-child Structure, Back/Up/Root/Trail, Search, Details, file-open safety, themes, sensory preferences, Voice fallbacks, and synchronized graph/list automation; fresh interactive/installed qualification of the reworked shell, voice bundle, chrome, hardware, and accessibility remains a release gate |
